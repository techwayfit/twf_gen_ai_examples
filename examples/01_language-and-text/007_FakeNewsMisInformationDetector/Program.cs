using _007_FakeNewsMisInformationDetector.Components;
...
// Register a named HttpClient for the search API (15 s timeout per request)
...
builder.Services.AddTransient<FactCheckWorkflowService>();
