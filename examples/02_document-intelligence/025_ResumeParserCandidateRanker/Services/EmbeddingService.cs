...
/// Identical to the EmbeddingService used in 021_MultiDocumentResearchSynthesizer.
/// </summary>
public class EmbeddingService(IHttpClientFactory httpClientFactory)
{
    ...
    /// <summary>Returns the embedding vector for a single text string.</summary>
    ...
    /// <summary>Returns embedding vectors for multiple text strings in a single API call.</summary>
